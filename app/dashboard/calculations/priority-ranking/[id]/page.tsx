    ...
    <div className="space-y-6">
          ...
          <div className="px-4 py-3 border-b border-border bg-muted/20 flex items-center justify-between print:bg-gray-50 print:border-black/20">
            <div>
              ...
              <p className="text-xs text-muted-foreground print:text-gray-500 mt-0.5">
                Urutan prioritas restock berdasarkan nilai preferensi Vi
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 text-center hidden sm:table-cell">
                      {(() => {
                        const cat =
                          r.product?.movement_category ?? "slow_moving";
                        ...
                        return (
                          <span
                            className={cn(
                              "text-xs px-2 py-0.5 rounded-full font-medium print:rounded-none print:bg-transparent print:text-gray-600",
                              cls[cat] ?? cls.slow_moving,
                            )}
                          >
                            {lbl[cat] ?? cat}
                          </span>
      ...
      <div className="rounded-xl border border-border bg-card p-5 space-y-4 print:border-black/20 print:bg-white print:rounded-none print:border print:p-4">
        ...
        <div className="space-y-3 text-sm text-muted-foreground print:text-gray-700 print:text-xs leading-relaxed">
          ...
          <p>
            Hasil perangkingan di atas merupakan{" "}
            <strong className="text-foreground print:text-black">
              rekomendasi otomatis
            </strong>{" "}
            yang dihasilkan oleh Sistem Pendukung Keputusan (SPK) berbasis
            metode{" "}
            ...
            ). Sistem menganalisis {calc.total_alternatives} produk aktif
            berdasarkan {CRITERIA.length} kriteria terbobot menggunakan data
          ...
          <p>
            Nilai preferensi (Vi) merepresentasikan kedekatan relatif setiap
            produk terhadap solusi ideal positif. Semakin mendekati nilai 1,
            semakin tinggi prioritas produk tersebut untuk direstok berdasarkan
            kombinasi tingkat penjualan, kondisi stok, harga modal, dan margin
            keuntungan.
          </p>
          ...
          <div className="rounded-lg bg-muted/40 border border-border px-4 py-3 print:bg-gray-50 print:border-gray-200">
            <p className="text-xs font-semibold text-foreground mb-2 print:text-black">
              Keterangan Warna Stok (C2):
            </p>
            <div className="flex flex-wrap gap-x-5 gap-y-1 text-xs">
              <span className="text-destructive font-medium print:text-red-700">
                ■ Merah — Stok kritis (≤ 2 unit)
              </span>
              <span className="text-yellow-600 dark:text-yellow-400 font-medium print:text-yellow-700">
                ■ Kuning — Stok rendah (3–7 unit)
              </span>
              <span className="text-foreground print:text-black">
                ■ Normal — Stok aman (≥ 8 unit)
              </span>
            </div>
          </div>

          <p className="text-xs italic print:text-gray-500">
            <strong className="not-italic text-foreground print:text-black">
              Penting:
            </strong>{" "}
            Rekomendasi ini bersifat pendukung keputusan dan tidak menggantikan
            pertimbangan bisnis manajemen toko. Keputusan akhir mengenai
            pengadaan atau restok barang sepenuhnya berada pada wewenang pihak
            manajemen. Hasil ini dibuat secara otomatis oleh sistem pada{" "}
            {formatDate(calc.calculation_date)}.
          </p>
        </div>
      </div>
