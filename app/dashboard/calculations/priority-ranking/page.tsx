...
export default async function PriorityRankingCalculationsPage() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Riwayat kalkulasi TOPSIS untuk penentuan prioritas barang.
        </p>
      </div>
      <div className="rounded-xl border border-border bg-card flex flex-col items-center justify-center py-16 gap-3">
        ...
        <p className="text-xs text-muted-foreground text-center max-w-xs">
          Kalkulasi Priority Ranking sedang dalam pengembangan.
        </p>
      </div>
    </div>
  );
