    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        <h1 className="text-2xl font-semibold text-foreground">
          Kriteria Priority Ranking
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          Atur bobot dan sub-kriteria untuk kalkulasi TOPSIS priority ranking.
        </p>
      </div>
      <div className="rounded-xl border border-border bg-card flex flex-col items-center justify-center py-16 gap-3">
        ...
        <p className="text-xs text-muted-foreground text-center max-w-xs">
          Manajemen kriteria Priority Ranking sedang dalam pengembangan.
        </p>
      </div>
    </div>
  );
